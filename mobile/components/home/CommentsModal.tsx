  ...
  return (
    ...
    >
      <SafeAreaView className="flex-1 bg-white">
        {/* MODAL HEADER */}
        <View className="flex-row items-center justify-between px-4 py-3 border-gray-100">
            ...
            <View className="p-4 border-t border-gray-100">
              <View className="flex-row">
                ...
                <View className="flex-1">
                  ...
                  <TouchableOpacity
                    className={`px-4 py-2 rounded-lg self-start w-20 items-center justify-center ${
                      commentText.trim() || isCreatingComment
                        ? "bg-blue-500"
                        : "bg-gray-300"
                    }`}
